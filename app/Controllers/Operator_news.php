...
class Operator_news extends BaseController{
	...
	public function index(){
		if(session()->get('high')){
			...
			return view('operator/news',$data);
	...
	public function save(){
		...
		return redirect()->to(base_url('o/berita'));
	}
	...
	public function detail($x){
		...
		return view('operator/newsdetail',$data);
	}
	...
	public function change(){
		...
		return redirect()->to(base_url('o/beritadetail/'.$get['id']));
	}
	...
	public function deleteimage($x){
		...
		return redirect()->to(base_url('o/beritadetail/'.$id));
	}
