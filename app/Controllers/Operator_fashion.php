...
class Operator_fashion extends BaseController{
	...
	public function index(){
		if(session()->get('high')){
			...
			return view('operator/fashion',$data);
	...
	public function save(){
		...
		$id = $this->mod->getData('post',['waktu' => $waktu, 'kategori' => '3'])['idpost'];
		...
		return redirect()->to(base_url('o/fashion'));
	}
	...
	public function detail($x){
		...
		return view('operator/fashiondetail',$data);
	}
	...
	public function change(){
		...
		return redirect()->to(base_url('o/fashiondetail/'.$get['id']));
	}
	...
	public function deleteimage($x){
		...
		return redirect()->to(base_url('o/fashiondetail/'.$id));
	}
