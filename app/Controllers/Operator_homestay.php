...
class Operator_homestay extends BaseController{
	...
	public function index(){
		if(session()->get('high')){
			...
			return view('operator/homestay',$data);
	...
	public function save(){
		...
		$id = $this->mod->getData('post',['waktu' => $waktu, 'kategori' => '2'])['idpost'];
		...
		return redirect()->to(base_url('o/homestay'));
	}
	...
	public function detail($x){
		...
		return view('operator/homestaydetail',$data);
	}
	...
	public function change(){
		...
		return redirect()->to(base_url('o/homestaydetail/'.$get['id']));
	}
	...
	public function deleteimage($x){
		...
		return redirect()->to(base_url('o/homestaydetail/'.$id));
	}
