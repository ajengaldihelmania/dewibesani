...
class Operator_creation extends BaseController{
	...
	public function index(){
		if(session()->get('high')){
			...
			return view('operator/creation',$data);
	...
	public function save(){
		...
		$id = $this->mod->getData('post',['waktu' => $waktu, 'kategori' => '4'])['idpost'];
		...
		return redirect()->to(base_url('o/kriya'));
	}
	...
	public function detail($x){
		...
		return view('operator/creationdetail',$data);
	}
	...
	public function change(){
		...
		return redirect()->to(base_url('o/kriyadetail/'.$get['id']));
	}
	...
	public function deleteimage($x){
		...
		return redirect()->to(base_url('o/kriyadetail/'.$id));
	}
