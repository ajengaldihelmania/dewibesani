...
class Operator_tour extends BaseController{
	...
	public function index(){
		if(session()->get('high')){
			...
			return view('operator/tour',$data);
	...
	public function save(){
		...
		$id = $this->mod->getData('post',['waktu' => $waktu, 'kategori' => '0'])['idpost'];
		...
		return redirect()->to(base_url('o/wisata'));
	}
	...
	public function detail($x){
		...
		return view('operator/tourdetail',$data);
	}
	...
	public function change(){
		...
		return redirect()->to(base_url('o/wisatadetail/'.$get['id']));
	}
	...
	public function deleteimage($x){
		...
		return redirect()->to(base_url('o/wisatadetail/'.$id));
	}
