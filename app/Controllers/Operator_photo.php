...
class Operator_photo extends BaseController{
	...
	public function index(){
		if(session()->get('high')){
			...
			return view('operator/photo',$data);
	...
	public function save(){
		...
		$id = $this->mod->getData('post',['waktu' => $waktu, 'kategori' => '6'])['idpost'];
		...
		return redirect()->to(base_url('o/foto'));
	}
	...
	public function detail($x){
		...
		return view('operator/photodetail',$data);
	}
	...
	public function change(){
		...
		return redirect()->to(base_url('o/fotodetail/'.$get['id']));
	}
	...
	public function deleteimage($x){
		...
		return redirect()->to(base_url('o/fotodetail/'.$id));
	}
