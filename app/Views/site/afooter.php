                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-widget mb-40">
                        ...
                        <div class="footer-content">
                            <ul>
                                <li><a href="<?php echo base_url('tentang') ?>">Tentang <?php echo $info['nama'] ?></a></li>
                                <li><a href="<?php echo base_url('visimisi') ?>">Visi Misi</a></li>
                                <li><a href="<?php echo base_url('fasilitas') ?>">Fasilitas</a></li>
                                <li><a href="<?php echo base_url('sk') ?>">Syarat dan Ketentuan</a></li>
                                <li><a href="<?php echo base_url('bantuan') ?>">Bantuan Sistem</a></li>
                    ...
                    <div class="footer-widget mb-40">
                        ...
                        <div class="footer-content">
                            <ul>
                                ...
                                <li><a href="<?php echo base_url('kontak') ?>">Kirim Masukan</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="footer-about">
                            ...
                            <div class="footer-contact mt-20">
                                <ul>
                                    ...
                                    <li><a href="<?php echo base_url('aksesadmin') ?>" style="color: white;"><i class="fa fa-key" style="color: white;"></i>Administrator</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
