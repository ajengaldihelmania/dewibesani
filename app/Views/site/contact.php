        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form action="<?php echo base_url('respon/s') ?>" method="post">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="contact-form-style mb-20">
                                    <input name="nama" placeholder="Nama Lengkap" type="text" maxlength="63" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="contact-form-style mb-20">
                                    <input name="kontak" placeholder="Email atau Telepon" type="text" maxlength="99" required>
                                </div>
                            </div>
                            <div class="col-lg-12">
