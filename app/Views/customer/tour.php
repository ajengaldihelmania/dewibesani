        ...
        <div class="container">
            <div class="breadcrumb-content text-center">
                ...
                <ul>
                    ...
                    <li class="active">Potensi Wisata</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        foreach ($data as $d) {
                            ...
                            <div class="single-blog-wrapper mb-40">
                                <div class="blog-img mb-30">
                                    <a href="<?php echo base_url('c/wisata/d/'.$d['idpost']) ?>">
                                        <img src="<?php echo base_url('assets/gambar/thumbnail/'.$thumb) ?>" alt="">
                                    </a>
                                </div>
                                <div class="blog-content">
                                    <h2><a href="<?php echo base_url('c/wisata/d/'.$d['idpost']) ?>"><?php echo $d['judul'] ?></a></h2>
                                    <div class="blog-date-categori">
                                        <ul>
                                            <li><?php echo tgl_indo(date('Y-m-d', strtotime($d['waktu']))) ?></li>
                                            <li><a href="<?php echo base_url('c/wisata/c/'.$d['idpengguna']) ?>"><?php echo $creator ?> </a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="blog-btn-social mt-30">
                                    <div class="blog-btn">
                                        <a href="<?php echo base_url('c/wisata/d/'.$d['idpost']) ?>">Baca Semua</a>
                                    </div>
                                    <div class="blog-social">
                                        <span>Bagikan :</span>
                                        <ul>
                                            <li><a href="https://twitter.com/share?url=<?php echo base_url('wisata/s/'.$s) ?>" target="blank"><i class="ion-social-twitter"></i></a></li>
                                            <li><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo base_url('wisata/s/'.$s) ?>" target="blank"><i class="ion-social-facebook"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                foreach ($terbaru as $tb) {
                                    ...
                                    <div class="recent-post-wrapper mb-25">
                                        <div class="recent-post-img">
                                            <a href="<?php echo base_url('c/wisata/d/'.$tb['idpost']) ?>"><img src="<?php echo base_url('assets/gambar/thumbnail/'.$thumb) ?>" alt=""></a>
                                        </div>
                                        <div class="recent-post-content">
                                            <h4><a href="<?php echo base_url('c/wisata/d/'.$tb['idpost']) ?>"><?php echo $tb['judul'] ?></a></h4>
