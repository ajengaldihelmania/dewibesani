                ...
                <div class="col-lg-8 col-xl-9 col-md-8">
                    <div class="blog-details-wrapper">
                        <div class="single-blog-wrapper">
                            <?php if(count($thumbnail) > 1){ ?>
                                <div class="blog-gallery-slider owl-carousel mb-30">
                                    <?php foreach ($thumbnail as $t) {?>
                                        <a><img alt="" src="<?php echo base_url('assets/gambar/thumbnail/'.$t['thumbnail']) ?>" style="object-fit: cover;height: 600px;"></a>
                                    <?php } ?>
                                </div>
                            <?php }else{
                                ...
                                <div class="blog-img mb-30">
                                    <img src="<?php echo base_url('assets/gambar/thumbnail/'.$thumbnail) ?>" alt="">
                                </div>
                            <?php } ?>
