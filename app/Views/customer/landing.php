                ...
                foreach ($paket as $p) {
                    ...
                    <div class="product-wrapper">
                        <div class="product-img">
                            <a href="<?php echo base_url('c/paket/d/'.$p['idpaket']) ?>">
                        ...
                        <div class="product-content text-left">
                            <div class="product-hover-style">
                                <div class="product-title">
                                    <h4>
                                        <a href="<?php echo base_url('c/paket/d/'.$p['idpaket']) ?>"><?php echo substr($p['paket'],0,50) ?>...</a>
                                    </h4>
                                </div>
                                <div class="cart-hover">
                                    <h4><a href="<?php echo base_url('c/paket/d/'.$p['idpaket']) ?>">+ Lihat Detail</a></h4>
                                </div>
                            </div>
                    ...
                    <?php foreach ($video as $v) {?>
                        <div class="col-lg-6 col-md-6">
                            <div class="single-banner img-zoom mb-30">
                                <a href="<?php echo base_url('c/video/d/'.$v['idpost']) ?>">
                        ...
                        foreach ($foto as $f) {
                            ...
                            <div class="product-wrapper-single">
                                <div class="product-wrapper mb-30">
                                    <div class="product-img">
                                        <a href="<?php echo base_url('c/foto/d/'.$f['idpost']) ?>">
                                    ...
                                    <div class="product-content text-left">
                                        <div class="product-hover-style">
                                            <div class="product-title">
                                                <h4>
                                                    <a href="<?php echo base_url('c/foto/d/'.$f['idpost']) ?>"><?php echo substr($f['judul'],0,50) ?>...</a>
                                                </h4>
                                            </div>
                                            <div class="cart-hover">
                                                <h4><a href="<?php echo base_url('c/foto/d/'.$f['idpost']) ?>">Lihat Selengkapnya</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
