                  ...
                  <div class="col-12 col-md-6 order-md-2 order-first">
                     <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item active" aria-current="page">Dokumentasi Video</li>
                        </ol>
                     </nav>
                  </div>
               </div>
                        ...
                        <tbody>
                           ...
                           foreach ($data as $d) {
                              ...
                              <tr <?php if($d['status'] == '0'){echo "style='background-color:rgba(255,213,0,0.1)'";} ?>>
                                 ...
                                 <td>
                                    <a href="<?php echo base_url('o/videodetail/'.$d['idpost']) ?>" class="btn btn-sm btn-warning" title="Klik untuk ubah data"><i class="bi bi-pencil-square"></i></a>
                                    <?php if($comment == 0){ ?>
...
<div class="modal fade text-left modal-borderless" id="tambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
   <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
      <div class="modal-content">
         ...
         <form action="<?php echo base_url('o/videosimpan') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
               ...
               <div class="row">
                  ...
                  <div class="form-group col-4">
                     ...
                     <input type="file" name="video" class="form-control form-control-sm" accept="video/mp4,video/x-m4v,video/*" id="video" required>
                  </div>
               </div>
               <div class="form-group">
                  <input class="mt-4" type="checkbox" name="link" value="1" id="link" onclick="pilihan()" /> <label for="link">Gunakan Link Video</label>
                  <input type="text" class="form-control form-control-sm" id="tautan" placeholder="Link atau Tautan" name="tautan" disabled="true" required>
               </div>
            </div>
   ...
   <div class="modal fade text-left modal-borderless" id="h<?php echo $d['idpost'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-scrollable" role="document">
         <div class="modal-content">
            ...
            <div class="modal-footer">
               <button type="button" class="btn btn-sm btn-grey" data-bs-dismiss="modal"><i class="bx bx-x d-block d-sm-none"></i><span class="d-none d-sm-block">Batal</span></button>
               <a href="<?php echo base_url('o/videohapus/'.$d['idpost']) ?>" class="btn btn-sm btn-danger"><i class="bx bx-x d-block d-sm-none"></i><span class="d-none d-sm-block">Ya, Hapus</span></a>
            </div>
         </div>
      </div>
   </div>
...
<script>
   function pilihan() {
      var cek = document.getElementById("link");
      var video = document.getElementById("video");
      var tautan = document.getElementById("tautan");
      if(cek.checked){
         tautan.disabled = false;
         tautan.focus();
         video.disabled = true;
      }else{
         tautan.disabled = true;
