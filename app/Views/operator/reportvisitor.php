      ...
      <div id="main">
         ...
         <div class="page-heading">
            ...
            <section class="section">
               <div class="card">
                  <div class="card-body">
                     <form method="post" action="<?php echo base_url('o/laporankunjungantampil') ?>" style="float: right;">
                        <div class="input-group">
                           ...
                           <a href="<?php echo base_url('o/laporankunjungancetak/'.$dari.'_'.$sampai) ?>" target="blank" class="btn btn-primary btn-sm">Cetak Data</a>
                        </div>
                     </form>
